...
const char* deviceToken = "S6AtZAlYfH6mkhTABdoI"; // Lo encuentras en ThingsBoard al crear el dispositivo
...
void callback(char* topic, byte* payload, unsigned int length) {
 ...
 if (String(topic) == "v1/devices/me/attributes/led_control") {
 if (message == "true") {
...
void reconnect() {
 ...
 String attributeTopic = "v1/devices/me/attributes/led_control";
